...
router.get("/CoursesDetails", (req, res) => {
...
router.get("/CoursesDetails/:CourseID", (req, res) => {
...
router.get("/PrincipalInstructorList", (req, res) => {
  const InstructorID=req.session.InstructorID;
...
router.post("/PrincipalupdateInstructor/:InstructorID", (req, res) => {
...
if(InstructorID2==InstructorID){
 ...
 router.get("/PrincipalDeleteCourses/:CourseID", (req, res) => {
    const InstructorID = req.session.InstructorID;
    const CourseID = req.params.CourseID;
    const AdminID="646e58091c39984480839ff3";
...
router.post("/CoursesUpdate/:CourseID", (req, res) => {
